      ...
      for (int x = 0; x < cols; x++) 
        {
                ...
                for (int grx=0;grx<grX;grx++)
                  ...
                  M5.Lcd.setCursor((boxWidth *x)+((boxWidth*grX)/3), (boxHeight *y)+((boxHeight*grY)/3)); // update spot temp text
                  M5.Lcd.print(val, 0);
                 }
        }
    } 
